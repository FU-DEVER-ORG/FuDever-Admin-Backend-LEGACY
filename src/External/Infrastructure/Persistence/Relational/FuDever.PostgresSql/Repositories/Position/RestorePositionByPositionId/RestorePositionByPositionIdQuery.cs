...
internal sealed class RestorePositionByPositionIdQuery : IRestorePositionByPositionIdQuery
{
    private readonly RestorePositionByPositionIdStateBag _stateBag;

    internal RestorePositionByPositionIdQuery(RestorePositionByPositionIdStateBag stateBag)
    {
        _stateBag = stateBag;
    }
