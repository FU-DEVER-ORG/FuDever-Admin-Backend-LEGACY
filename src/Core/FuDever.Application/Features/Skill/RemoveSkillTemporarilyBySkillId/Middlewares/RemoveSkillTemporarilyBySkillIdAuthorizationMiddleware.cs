...
internal sealed class RemoveSkillTemporarilyBySkillIdAuthorizationMiddleware
    : IPipelineBehavior<
        ...
        IRemoveSkillTemporarilyBySkillIdMiddleware
{
    ...
    public RemoveSkillTemporarilyBySkillIdAuthorizationMiddleware(ISender sender)
    {
        _sender = sender;
    }
    ...
    )
    {
        ...
        foreach (var requirement in requirements)
        {
            ...
            if (result.IsForbidden)
            {
                return new()
                {
                    StatusCode = RemoveSkillTemporarilyBySkillIdResponseStatusCode.FORBIDDEN
                };
            }
            ...
            if (!result.IsAuthorized)
            {
                return new()
                {
                    StatusCode = RemoveSkillTemporarilyBySkillIdResponseStatusCode.UN_AUTHORIZED
                };
            }
        }
