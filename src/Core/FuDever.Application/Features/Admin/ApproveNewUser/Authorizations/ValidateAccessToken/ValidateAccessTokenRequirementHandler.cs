...
namespace FuDever.Application.Features.Admin.ApproveNewUser.Authorizations.ValidateAccessToken;
    ...
    : IAppAuthorizationRequirementHandler<ValidateAccessTokenRequirement>
{
    ...
    )
    {
        ...
        var isRefreshTokenFound =
            await _unitOfWork.AdminFeature.ApproveNewUser.Query.IsRefreshTokenFoundByAccessTokenIdQueryAsync(
