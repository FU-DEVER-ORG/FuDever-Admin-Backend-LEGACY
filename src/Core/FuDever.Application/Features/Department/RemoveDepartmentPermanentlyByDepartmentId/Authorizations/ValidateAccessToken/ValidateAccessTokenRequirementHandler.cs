...
namespace FuDever.Application.Features.Department.RemoveDepartmentPermanentlyByDepartmentId.Authorizations.ValidateAccessToken;
    ...
    : IAppAuthorizationRequirementHandler<ValidateAccessTokenRequirement>
{
    ...
    )
    {
        ...
        var isRefreshTokenFound =
            await _unitOfWork.DepartmentFeature.RemoveDepartmentPermanentlyByDepartmentId.Query.IsRefreshTokenFoundByAccessTokenIdQueryAsync(
        ...
        var isUserNotTemporarilyRemoved =
            await _unitOfWork.DepartmentFeature.RemoveDepartmentPermanentlyByDepartmentId.Query.IsUserNotTemporarilyRemovedQueryAsync(
                userId: foundUser.Id,
                cancellationToken: cancellationToken
            );
