...
internal sealed class RemoveMajorTemporarilyByMajorIdQuery : IRemoveMajorTemporarilyByMajorIdQuery
{
    private readonly RemoveMajorTemporarilyByMajorIdStateBag _stateBag;

    internal RemoveMajorTemporarilyByMajorIdQuery(RemoveMajorTemporarilyByMajorIdStateBag stateBag)
    {
        _stateBag = stateBag;
    }
