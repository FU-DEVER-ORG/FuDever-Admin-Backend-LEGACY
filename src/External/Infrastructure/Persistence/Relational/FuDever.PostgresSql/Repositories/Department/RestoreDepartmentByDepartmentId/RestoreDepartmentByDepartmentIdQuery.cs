...
internal sealed class RestoreDepartmentByDepartmentIdQuery : IRestoreDepartmentByDepartmentIdQuery
{
    private readonly RestoreDepartmentByDepartmentIdStateBag _stateBag;

    public RestoreDepartmentByDepartmentIdQuery(RestoreDepartmentByDepartmentIdStateBag stateBag)
    {
        _stateBag = stateBag;
    }
