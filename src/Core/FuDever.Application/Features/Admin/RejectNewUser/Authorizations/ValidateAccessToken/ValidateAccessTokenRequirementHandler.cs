...
namespace FuDever.Application.Features.Admin.RejectNewUser.Authorizations.ValidateAccessToken;
    ...
    : IAppAuthorizationRequirementHandler<ValidateAccessTokenRequirement>
{
    ...
    )
    {
        ...
        var isRefreshTokenFound =
            await _unitOfWork.AdminFeature.RejectNewUser.Query.IsRefreshTokenFoundByAccessTokenIdQueryAsync(
