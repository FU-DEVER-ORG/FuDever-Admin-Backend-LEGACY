        ...
        IGetAllTemporarilyRemovedHobbiesMiddleware
{
    ...
    public GetAllTemporarilyRemovedHobbiesValidationMiddleware(
        IValidator<GetAllTemporarilyRemovedHobbiesRequest> validator
    )
    {
    ...
    )
    {
        ...
        if (!inputValidationResult.IsValid)
        {
            ...
            {
                StatusCode =
                    GetAllTemporarilyRemovedHobbiesResponseStatusCode.INPUT_VALIDATION_FAIL,
