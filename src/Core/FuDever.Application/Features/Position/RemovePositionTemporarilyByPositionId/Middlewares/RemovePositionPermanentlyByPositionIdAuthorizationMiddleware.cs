...
internal sealed class RemovePositionTemporarilyByPositionIdAuthorizationMiddleware
    : IPipelineBehavior<
        ...
        IRemovePositionTemporarilyByPositionIdMiddleware
{
    ...
    public RemovePositionTemporarilyByPositionIdAuthorizationMiddleware(ISender sender)
    {
        _sender = sender;
    }
    ...
    )
    {
        ...
        foreach (var requirement in requirements)
        {
            ...
            if (result.IsForbidden)
            {
                return new()
                {
                    StatusCode = RemovePositionTemporarilyByPositionIdResponseStatusCode.FORBIDDEN
                };
            }
            ...
            if (!result.IsAuthorized)
            {
                ...
                {
                    StatusCode =
                        RemovePositionTemporarilyByPositionIdResponseStatusCode.UN_AUTHORIZED
                };
            }
        }
