...
/// <summary>
///     Implementation for restore position
///     by position id http response.
/// </summary>
internal class RestorePositionByPositionIdHttpResponse
{
    [JsonIgnore]
    public int HttpCode { get; init; }

    public string AppCode { get; init; } =
        RestorePositionByPositionIdResponseStatusCode.OPERATION_SUCCESS.ToAppCode();
