...
namespace FuDever.Application.Features.Auth.RefreshAccessToken.Authorizations.ValidateAccessToken;
    ...
    : IAppAuthorizationRequirementHandler<ValidateAccessTokenRequirement>
{
    ...
    )
    {
        ...
        if (
            ...
            && validateTokenResult.Exception is not SecurityTokenExpiredException
        )
        {
        ...
        var isRefreshTokenFound =
            await _unitOfWork.AuthFeature.RefreshAccessToken.Query.IsRefreshTokenFoundByAccessTokenIdQueryAsync(
        ...
        var isUserNotTemporarilyRemoved =
            await _unitOfWork.AuthFeature.RefreshAccessToken.Query.IsUserNotTemporarilyRemovedQueryAsync(
                userId: foundUser.Id,
                cancellationToken: cancellationToken
            );
