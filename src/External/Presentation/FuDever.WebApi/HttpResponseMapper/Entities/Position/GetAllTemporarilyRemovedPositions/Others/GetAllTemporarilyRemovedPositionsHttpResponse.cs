...
///     removed positions http response.
/// </summary>
internal class GetAllTemporarilyRemovedPositionsHttpResponse
{
    [JsonIgnore]
    public int HttpCode { get; init; }

    public string AppCode { get; init; } =
        GetAllTemporarilyRemovedPositionsResponseStatusCode.OPERATION_SUCCESS.ToAppCode();
