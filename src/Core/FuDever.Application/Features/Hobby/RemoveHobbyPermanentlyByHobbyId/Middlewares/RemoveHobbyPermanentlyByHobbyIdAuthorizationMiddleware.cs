...
internal sealed class RemoveHobbyPermanentlyByHobbyIdAuthorizationMiddleware
    : IPipelineBehavior<
        ...
        IRemoveHobbyPermanentlyByHobbyIdMiddleware
{
    ...
    public RemoveHobbyPermanentlyByHobbyIdAuthorizationMiddleware(ISender sender)
    {
        _sender = sender;
    }
    ...
    )
    {
        ...
        foreach (var requirement in requirements)
        {
            ...
            if (result.IsForbidden)
            {
                return new()
                {
                    StatusCode = RemoveHobbyPermanentlyByHobbyIdResponseStatusCode.FORBIDDEN
                };
            }
            ...
            if (!result.IsAuthorized)
            {
                return new()
                {
                    StatusCode = RemoveHobbyPermanentlyByHobbyIdResponseStatusCode.UN_AUTHORIZED
                };
            }
        }
