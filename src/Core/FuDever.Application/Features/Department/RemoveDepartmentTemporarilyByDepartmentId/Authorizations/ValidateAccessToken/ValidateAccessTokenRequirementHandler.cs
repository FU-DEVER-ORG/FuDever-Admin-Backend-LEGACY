...
namespace FuDever.Application.Features.Department.RemoveDepartmentTemporarilyByDepartmentId.Authorizations.ValidateAccessToken;
    ...
    : IAppAuthorizationRequirementHandler<ValidateAccessTokenRequirement>
{
    ...
    )
    {
        ...
        var isRefreshTokenFound =
            await _unitOfWork.DepartmentFeature.RemoveDepartmentTemporarilyByDepartmentId.Query.IsRefreshTokenFoundByAccessTokenIdQueryAsync(
        ...
        var isUserNotTemporarilyRemoved =
            await _unitOfWork.DepartmentFeature.RemoveDepartmentTemporarilyByDepartmentId.Query.IsUserNotTemporarilyRemovedQueryAsync(
                userId: foundUser.Id,
                cancellationToken: cancellationToken
            );
