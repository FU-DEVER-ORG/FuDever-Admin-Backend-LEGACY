...
namespace FuDever.Application.Features.Role.GetAllTemporarilyRemovedRoles.Authorizations.ValidateAccessToken;
    ...
    : IAppAuthorizationRequirementHandler<ValidateAccessTokenRequirement>
{
    ...
    )
    {
        ...
        var isRefreshTokenFound =
            await _unitOfWork.RoleFeature.GetAllTemporarilyRemovedRoles.Query.IsRefreshTokenFoundByAccessTokenIdQueryAsync(
        ...
        var isUserNotTemporarilyRemoved =
            await _unitOfWork.RoleFeature.GetAllTemporarilyRemovedRoles.Query.IsUserNotTemporarilyRemovedQueryAsync(
                userId: foundUser.Id,
                cancellationToken: cancellationToken
            );
