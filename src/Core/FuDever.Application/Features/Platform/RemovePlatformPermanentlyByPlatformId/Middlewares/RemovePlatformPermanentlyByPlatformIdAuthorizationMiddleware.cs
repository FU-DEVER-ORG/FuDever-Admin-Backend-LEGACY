...
internal sealed class RemovePlatformPermanentlyByPlatformIdAuthorizationMiddleware
    : IPipelineBehavior<
        ...
        IRemovePlatformPermanentlyByPlatformIdMiddleware
{
    ...
    public RemovePlatformPermanentlyByPlatformIdAuthorizationMiddleware(ISender sender)
    {
        _sender = sender;
    }
    ...
    )
    {
        ...
        foreach (var requirement in requirements)
        {
            ...
            if (result.IsForbidden)
            {
                return new()
                {
                    StatusCode = RemovePlatformPermanentlyByPlatformIdResponseStatusCode.FORBIDDEN
                };
            }
            ...
            if (!result.IsAuthorized)
            {
                ...
                {
                    StatusCode =
                        RemovePlatformPermanentlyByPlatformIdResponseStatusCode.UN_AUTHORIZED
                };
            }
        }
