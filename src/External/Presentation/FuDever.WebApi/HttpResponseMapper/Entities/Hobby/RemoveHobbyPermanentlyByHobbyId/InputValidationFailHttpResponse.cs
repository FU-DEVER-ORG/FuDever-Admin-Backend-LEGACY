...
/// </summary>
internal sealed class InputValidationFailHttpResponse : RemoveHobbyPermanentlyByHobbyIdHttpResponse
{
    internal InputValidationFailHttpResponse(RemoveHobbyPermanentlyByHobbyIdResponse response)
    {
