...
internal sealed class UpdatePlatformByPlatformIdQuery : IUpdatePlatformByPlatformIdQuery
{
    private readonly UpdatePlatformByPlatformIdStateBag _stateBag;

    internal UpdatePlatformByPlatformIdQuery(UpdatePlatformByPlatformIdStateBag stateBag)
    {
        _stateBag = stateBag;
    }
