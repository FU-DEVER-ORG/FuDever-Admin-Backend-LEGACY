...
public interface ICreateMajorQuery
{
    /// <summary>
    ...
    /// <summary>
    ///     Is major with the same name found by major name query.
    /// </summary>
    ...
    /// </param>
    /// <returns>
    ///     True if major with the same name found. Otherwise, false.
    /// </returns>
    Task<bool> IsMajorWithTheSameNameFoundByMajorNameQueryAsync(
        string newMajorName,
        CancellationToken cancellationToken
    );

    /// <summary>
    ///     Is major temporarily removed by major name query.
    /// </summary>
    /// <param name="newMajorName">
    ///     New major name.
    /// </param>
    ...
    /// </param>
    /// <returns>
    ///     True if major is temporarily removed. Otherwise, false.
    /// </returns>
    Task<bool> IsMajorTemporarilyRemovedByMajorNameQueryAsync(
        string newMajorName,
        CancellationToken cancellationToken
    );
}
