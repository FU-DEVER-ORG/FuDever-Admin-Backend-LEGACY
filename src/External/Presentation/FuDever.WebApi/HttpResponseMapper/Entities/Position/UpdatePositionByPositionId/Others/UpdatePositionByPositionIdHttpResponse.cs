...
/// <summary>
///     Implementation for update position
///     by position id http response.
/// </summary>
internal class UpdatePositionByPositionIdHttpResponse
{
    [JsonIgnore]
    public int HttpCode { get; init; }

    public string AppCode { get; init; } =
        UpdatePositionByPositionIdResponseStatusCode.OPERATION_SUCCESS.ToAppCode();
