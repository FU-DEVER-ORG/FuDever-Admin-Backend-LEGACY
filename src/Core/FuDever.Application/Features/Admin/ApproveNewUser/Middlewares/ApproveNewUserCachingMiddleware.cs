...
/// <summary>
///     Approve new user request caching middleware.
/// </summary>
[FeatureMiddlewareOrder(value: 3)]
internal sealed class ApproveNewUserCachingMiddleware
    : IPipelineBehavior<ApproveNewUserRequest, ApproveNewUserResponse>,
        IApproveNewUserMiddleware
{
    private readonly ICacheHandler _cacheHandler;

    public ApproveNewUserCachingMiddleware(ICacheHandler cacheHandler)
    {
    ...
    )
    {
        ...
        if (response.StatusCode == ApproveNewUserResponseStatusCode.OPERATION_SUCCESS)
        {
