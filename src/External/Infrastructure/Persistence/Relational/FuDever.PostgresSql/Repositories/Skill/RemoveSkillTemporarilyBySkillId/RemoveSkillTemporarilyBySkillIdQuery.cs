...
internal sealed class RemoveSkillTemporarilyBySkillIdQuery : IRemoveSkillTemporarilyBySkillIdQuery
{
    private readonly RemoveSkillTemporarilyBySkillIdStateBag _stateBag;

    internal RemoveSkillTemporarilyBySkillIdQuery(RemoveSkillTemporarilyBySkillIdStateBag stateBag)
    {
        _stateBag = stateBag;
    }
