...
namespace FuDever.Application.Features.Department.UpdateDepartmentByDepartmentId.Authorizations.ValidateAccessToken;
    ...
    : IAppAuthorizationRequirementHandler<ValidateAccessTokenRequirement>
{
    ...
    )
    {
        ...
        var isRefreshTokenFound =
            await _unitOfWork.DepartmentFeature.UpdateDepartmentByDepartmentId.Query.IsRefreshTokenFoundByAccessTokenIdQueryAsync(
        ...
        var isUserNotTemporarilyRemoved =
            await _unitOfWork.DepartmentFeature.UpdateDepartmentByDepartmentId.Query.IsUserNotTemporarilyRemovedQueryAsync(
                userId: foundUser.Id,
                cancellationToken: cancellationToken
            );
